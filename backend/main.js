  ...
  sections.forEach(current => {
    ...
    */
    if (
      ...
      console.log(".header-bottom-menud a[href*=" + sectionId + "]")
      document.querySelector(".header-bottom-menud a[href*=" + sectionId + "]").classList.add("active");
    } else {
      document.querySelector(".header-bottom-menud a[href*=" + sectionId + "]").classList.remove("active");
    }
  });
}
